...
public class Computer {
    ...
    // n9edro nzidou @Autowired hna o maghan7tajou la constructor la setter => field injection
    Keyboard keyboard; // Does not mean injected anything

    // Dependency khass tssb9 constructor
    // Constructor Injection
    Computer(Keyboard keyInject){
        System.out.println("Object of Computer created");
        this.keyboard=keyInject;
    }
